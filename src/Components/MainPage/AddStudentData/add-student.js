                                ...
                                <div style={{display: "flex" , width: "100%"}}>
                                    <MuiPickersUtilsProvider utils={DateFnsUtils} >
                                        <DatePicker disableFuture openTo="year" format="dd/MM/yyyy" views={["year", "month", "date"]}
                                            inputVariant="filled" value={this.state.dateOfBirth} label='Date of Birth' onChange={this.handleDateChange.bind(this , 'dateOfBirth')} style={{flex: "1 1"}}/>
                                    </MuiPickersUtilsProvider>
                                    &nbsp;
                                    &nbsp;
                                    <MuiPickersUtilsProvider utils={DateFnsUtils} >
                                        <DatePicker disableFuture openTo="year" format="dd/MM/yyyy" views={["year", "month", "date"]}
                                            inputVariant="filled" value={this.state.admissionDate} label="Date of Admission" onChange={this.handleDateChange.bind(this , "admissionDate")} style={{flex: "1 1"}}/>
                                    </MuiPickersUtilsProvider>
                                </div>
                                <br/>
                                <div style={{display: "flex" , width: "100%"}}>
